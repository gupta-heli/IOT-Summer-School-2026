...
*Course Coursework: Week 1, Assignment Q9 & Q10*
...
Here is the `.gitignore` configured to exclude compiled outputs, OS files, and IDE configuration folders (implemented in the root directory of this repository):
